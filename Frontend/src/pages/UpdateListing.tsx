...
export default function CreateListing() {
  ...
  useEffect(() => {
    const fetchListing = async () => {
      ...
      const res = await fetch(`${process.env.VITE_BASE_URL}/api/listing/get/${listingId}`);
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      setLoading(true);
      setError(false);
      const res = await fetch(`${process.env.VITE_BASE_URL}/api/listing/update/${params.listingId}`, {
        method: 'POST',
        headers: {
